...
- Syngas has 'simple' chemistry:
    ...
    - **Carbon capture**: exhaust fumes from factories + electricity $\longrightarrow$ carbon dioxide
    - **Methanation**: hydrogen + carbon dioxide $\longrightarrow$ syngas (+ water)
- Syngas is (mostly) **carbon-neutral** when renewable electricity is also used
